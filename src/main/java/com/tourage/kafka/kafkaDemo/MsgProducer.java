package com.tourage.kafka.kafkaDemo;


import cn.hutool.json.JSON;
import cn.hutool.json.JSONUtil;
import com.tourage.kafka.kafkaDemo.domain.Order;
 ...
 * MsgProducer.
 *
 * @author shitianyu 2022-06-28 11:04
 */
public class MsgProducer {
    ...
    public static void main(String[] args) throws InterruptedException, ExecutionException {
        ...
        props.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, "42.192.1.184:9092");
        /*
         发出消息持久化机制参数
        ...
        *//*
        ...
        for (int i = 1; i <= msgNum; i++) {
            ...
            ProducerRecord<String, String> producerRecord = new ProducerRecord<String, String>(TOPIC_NAME
                    , order.getOrderId().toString(), JSONUtil.toJsonStr(order));
